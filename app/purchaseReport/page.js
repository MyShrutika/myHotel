...
const PurchaseReport = () => {
  ...
  return (
    <>
      ...
      <h1 className="md:text-2xl text-md  font-bold mb-4 text-start">
        ...
        <div className="flex flex-wrap items-center mb-4 justify-center text-left ">
          ...
          <input
            ...
            className="border rounded-full p-2 text-gray-900 mb-2 sm:mb-0 ml-3 font-semibold md:text-base text-sm lg:w-48"
          />
          </div>
          <div className="mt-2">
          <button
            className="text-orange-600 font-bold py-1 rounded-full bg-orange-100 mr-2 px-2 shadow-md ml-3 md:text-base text-sm"
            onClick={handleSearch}
          >
            Search
          </button>
          <button
            className="text-orange-600 font-bold py-1 rounded-full bg-orange-100 mr-2 px-2 shadow-md md:text-base text-sm"
            onClick={handleReset}
          >
            Reset
          </button>
        ...
        <div className=" flex justify-center flex-col">
          ...
          <select
            ...
            className="border rounded-md p-2 text-gray-700 mb-2 sm:mb-0 w-fit justify-center flex md:text-base text-sm"
          >
        ...
        <div className="table-container max-h-[400px] overflow-x-auto max-w-full md:text-base text-sm ">
          <table
        ...
        <div className="mt-2 sm:float-right border p-4 flex s text-red-500 md:text-lg text-sm">
          <h2 className="text-black">
            {selectedVendor ? `${selectedVendor} ` : "All Vendors "}Balance
          </h2>
          <p className="font-bold ml-2">{totalBalance.toFixed(2)}</p>
        </div>
        <div className="mt-2 sm:float-right border p-4 flex md:text-lg text-sm">
          <h2 className="">Grand Total :</h2>
          <p className=" font-bold text-green-600">{mainGrandTotal.toFixed(2)}</p>
        </div>
        <div className="mt-2 sm:float-right border p-4 flex s text-green-500 md:text-lg text-sm">
        <h2 className="text-black">
