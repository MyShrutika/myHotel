...
const GroupMenu = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto mt-2 p-4 rounded-md flex flex-col md:flex-row bg-gray-50">
        <div className="w-full md:w-1/2 pr-4 mb-4 md:mb-0">    <div className="mb-4">
            <label
