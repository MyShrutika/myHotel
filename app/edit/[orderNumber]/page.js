  ...
  <div class="subtotal">
    ...
    ${
      hotelInfo && hotelInfo.gstPercentage > 0
        ? `<p>CGST (${hotelInfo.gstPercentage / 2}%)</p> <p>SGST (${
            hotelInfo.gstPercentage / 2
          }%)</p>`
        : ""
    }
    <p class="grandTotal">Grand Total: </p>
          ...
          <div class="datas">
            ...
            ${
              hotelInfo && hotelInfo.gstPercentage > 0
                ? `<p>${calculateTotal(currentOrder).CGST}</p><p>${
      ...
      <div className="container mx-auto  bg-white">
        <div className="flex lg:flex-row  shadow-lg">
            ...
            <div className=" flex flex-row px-4 ml-1 custom-scrollbars overflow-x-auto whitespace-nowrap">
              <span
                key="all-items"
                className={`cursor-pointer px-4 mt-1 py-1 mb-1 rounded-2xl text-sm font-semibold mr-4 ${
